...
$${\mbox{de droogte-indicator voor één simulatie en één jaar : droogte-ind-sim}}_{j;s} =  \sum_{m = 1}^{58}({\mbox {dagen_droog}}_{m;s;j}) / 58 $$
...
We kiezen hier voor gewogen gemidddelde (gewichten nemen lineair met de tijd af) omdat het beter het ecologisch effect weerspiegelt. 
...
$${\text{dagen_droog}}_{j;m;s} \sim NB(\overline{{\text{droogte-ind-sim}}}_{j;m;s}, \theta)  $$

$$\overline{{\text{droogte-ind-sim}}}_{j;m;s} = E({\text{dagen_droog}}_{j;m;s}) \sim {\text {jaar}_j} + (1 \vert{\text{meetlocatie}_m})  $$
of 
