...
```{r overlay-habitatkaart-GRTS-raster, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE}
...
```{r overlay-habitatkaart-GRTS-plot, eval=TRUE, echo=FALSE, fig.cap="Verspreiding van de GT-groepen", message=FALSE, warning=FALSE, include=TRUE}
...
```{r gemiddelde-oppervlakte-per-GTgroep, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
Indien een rastercel wel enkele peilbuizen heeft, weliswaar onvoldoende, dan zal deze rastercel tot meerdere categorieën behoren, afhankelijk van de kwaliteit van de meetreeksen (zie \@ref(indeling-cat)). 
...
```{r read-results-menyanthes, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r join-tubes-on-raster-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r cat1B-raster-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r cat1B-table-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r cat1B-plot-bis, eval= TRUE, fig.cap = "rastercellen met een onvoldoend aantal peilbuizen met een goede meetreeks", include= TRUE, echo= FALSE, warning= FALSE}
...
```{r tubes-cat1Ba-bis-vb, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
tubes_cat1B_bis <- 
...
```{r tubes-cat1Ba-bis, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r tubes-cat1Bb-bis-vb, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r tubes-cat1Bb-bis, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r berekenen-clusters-extra-criteria-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r synthese-clusters-extra-criteria-bis, eval= TRUE, include= TRUE, echo= FALSE}
sel_qual_bis <- 
  sel_qual_basis_bis %>% 
  group_by(rasterid, groupnr, rest_aantal_meetptn, rankclus_lastyear, rankclus_nryears) %>% 
  mutate(rankclus_temp = as.integer(paste0(rankclus_lastyear,rankclus_nryears))) %>% 
...
```{r cat2-table-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r cat2-raster-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r cat2-plot-bis, eval= TRUE, fig.cap = "rastercellen met een juist voldoende aantal peilbuizen", include= TRUE, echo= FALSE, warning= FALSE}
...
```{r tubes-cat2-bis, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r cat3-raster-bis, eval= TRUE, include= TRUE, echo= FALSE}
...
```{r cat3-table-bis, eval= TRUE, include= TRUE, echo= FALSE}
sel_cat3_table_bis <- 
  sel_qual_bis %>% 
      filter(rankclus <= maxrank ) %>% 
      group_by(rasterid, groupnr, rest_aantal_meetptn) %>% 
...
```{r cat3-plot-bis, eval= TRUE, fig.cap = "rastercellen met een overschot aan geschikte peilbuizen", include= TRUE, echo= FALSE, warning= FALSE}
...
```{r tubes-cat3-bis, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r check-volledigheid-analyse, eval=TRUE, echo=FALSE, message=TRUE, include=TRUE}
...
```{r inlezen-grts-rasters, eval=TRUE, echo=FALSE, message=TRUE, include=TRUE}
...
```{r tubes-excess-spatial, eval=TRUE, echo=FALSE, message=TRUE, include=TRUE}
...
```{r tubes-excess-plot, fig.cap = "de ligging van de beschikbare peilbuizen", eval=TRUE, echo=FALSE, message=TRUE, include=TRUE}
...
```{r grid-excess-table, eval=TRUE, echo=FALSE, message=TRUE, include=TRUE}
...
```{r assigning-tubes-grts, eval=TRUE, echo=FALSE, message=TRUE, include=TRUE}
...
```{r write-grts-tubes, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r grts-result-1B-table, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
...
```{r grts-result-3-table, eval=TRUE, echo=FALSE, message=FALSE, include=TRUE}
