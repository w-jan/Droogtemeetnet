...
We selecteren enkel de meetpunten die grondwaterpeilen meten (piëzometer of peilbuis). Voor de eenvoud benoemen we ze hier als peilbuizen. 
...
### Categorie 1A: Zijn er rastercellen met onvoldoende geschikte peilbuizen?

Tabel \@ref(tab:cat1A-table) geeft een overzicht per GT-groep van het aantal geselecteerde rastercellen zonder peilbuis of met een onvoldoende aantal peilbuizen.
...
```{r cat1B-plot, fig.cap = "rastercellen met een onvoldoende aantal peilbuizen met een goede meetreeks", warning= FALSE, message=FALSE}
...
### Categorie 1B: Rastercellen met een onvoldoende aantal **geschikte** peilbuizen
...
kable(sel_cat1B_table_bis %>% 
        group_by(groupnr ) %>% 
        summarise('aantal cellen met een onvoldoende aantal geschikte peilbuizen' = n(),
...
```{r cat1B-plot-bis, fig.cap = "rastercellen met een onvoldoende aantal peilbuizen met een goede meetreeks", message=FALSE}
