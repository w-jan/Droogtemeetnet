...
Er is hierbij een verschil gemaakt tussen rasters waar enkel uit peilbuizen van actueel lage kwaliteit kan gekozen worden en waar deze keuze kan gemaakt worden met peilbuizen met modelleerbare tijdreeksen. 
...
tubes_excess_tm <- raster_meetnet_poly_tm + 
  ...
  tm_symbols(size = 0.25, shapes.labels = "loc_code", col = "cat", clustering = FALSE) + tm_layout(title = "beschikbare peilbuizen voor selectie" , asp = 0)
