...
tubes_xg3 <- tubes_in_raster %>% 
  semi_join (tubes_xg3, by = "loc_code")
...
tubes_lgl_eval <- tubes_in_raster %>% 
  semi_join(tubes_lgl_eval, by = "loc_code")
```
...
Rastercellen van groep 4 ligt alle in de (zand)leemstreek [^2] en deze van groep 5 liggen uitsluitend in de duinstreek. 

[^2]: Dit is normaal, omdat alle cellen van deze groep in de (zand)leemstreek liggen.
