...
_**De vraag is of we deze groep meenemen.**_ 
_**We waren eerst voorstander om deze wel mee te nemen.**_
_**Het voordeel van deze groep is dat ze vermoedelijk het snelst op droogte zal reageren.**_ 
_**Ze hebben echter ook nadelen:**_

    _**dat je bij het uitzetten van een nieuw punt niet op voorhand weet of het wel grondwaterafhankelijk is.**_  
    _**dat sommige typen heel variabel zijn m.b.t. het grondwaterregime.
_**Deze nadelen worden nu als belangrijker beoordeeld.**_  
...
**_Een stratificatie laat toe om een globale uitspraak te doen._**
**_We raden echter ook aan in de beoordeling elke GT-groep apart mee te nemen, omdat ze verschillende signalen zullen geven._** 
