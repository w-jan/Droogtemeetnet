...
saveRDS(habmap_gw_raster_overlay, file.path("cache", "habmap_gw_raster_overlay.rds" ))

```
```{r tubes-cat1-polyg-result}
tubes_cat1_polyg <- readRDS(file.path("cache", "tubes_cat1_polyg.rds" ))
habmap_gw_raster_overlay <- readRDS(file.path("cache", "habmap_gw_raster_overlay.rds" ))
```
