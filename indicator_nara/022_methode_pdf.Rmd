...
We kiezen hier voor een eenvoudig, ongewogen, gemidddelde om dat dit beter het effect van een lopend gemiddelde op de evolutie weerspiegelt.
...
We berekenen een lopend gemiddelde voor een aantal tijdvensters (2, 4, 6, 8, 10 en 30 jaar). 
Net zoals bij de originele waarden kan voor een lopend gemiddelde met behulp van de formule van Rubin ook een betrouwbaarheidsinterval bepaald worden. 
