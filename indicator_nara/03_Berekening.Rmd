...
De figuren \@ref(fig:check-distribution-qq-poisson), \@ref(fig:check-distribution-qq-nbinom) en \@ref(fig:check-distribution-qq-binom) geven een voorbeeld van een QQ-plot voor resp. de poisson, de negatief-binomiale en binomiale verdeling.

```{r check-distribution-qq-poisson, fig.cap = "QQ-plot poisson-verdeling"}

poisson <- fitdistr(checkdistributie, "Poisson")
qqp(checkdistributie, "pois", lambda = poisson$estimate, id = FALSE)

```

```{r check-distribution-qq-nbinom, fig.cap = "QQ-plot negatief binomiale-verdeling"}
