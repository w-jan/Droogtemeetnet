...
Van deze GT-klasse is immers de grondwaterafhankelijkheid plaatsgebonden en (soms heel) variabel.
De twee natste GT-klassen worden samengevoegd, omdat deze klassen vermoedelijk het traagst een droogte-signaal zullen geven. 

Concreet: 
    - Het aantal stratificatielagen  = `r aantal_strat `
    - De verdeling van het aantal meetpunten per laag is (tabel \@ref(tab:GTgroepen-verdeling-over-strata)): 
```{r GTgroepen-verdeling-over-strata}
kobj <- kable(gw_types_groups, 
...
Voor het berekenen van de droogte-indicator doen we beroep op tijdreeksen van **_minimaal 30 jaren lang_**, al dan niet gemodelleerde, metingen en waarbij metingen van 2017 en 2018 uitgesloten werden. 
