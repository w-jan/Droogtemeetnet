...
1. Er kan een tijdsmodel met uitsluitend neerslag- en evapotranspiratiedata als verklarende reeksen voor samengesteld worden dat minstens 66% van de variatie in de waargenomen peilen (cfr. EVP, explained variance percentage, in de Menyanthes-software) kon verklaren.
2. De tijdreeks vertoont geen significante lineaire trend. 
