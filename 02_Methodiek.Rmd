...
if (pdfmaken == TRUE) {
  include_graphics(path = file.path("figures", "workflow_rasterselectie_portrait.jpg"))  
} else {
...
if (pdfmaken == TRUE) {
  include_graphics(path = file.path(".","figures", 
                                    "workflow_pbselectie_part1_portrait.jpg"))
} else {
...
if (pdfmaken == TRUE) {
  include_graphics(path = file.path(".","figures", 
                                    "workflow_pbselectie_part2_portrait.jpg"))
} else {
  include_graphics(path = file.path(".","figures", 
