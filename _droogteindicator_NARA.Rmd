...
Om geselecteerd te kunnen worden moest minstens 67 % van de variantie verklaard kunnen worden door weersvariabelen (neerslag en potentiële evaporatie) en mocht in de tijdreeks geen lineaire dalende of stijgende trend waarneembaar zijn. 
...
of 
$$trend + 1.96* se < -1(cm/jaar)$$
Voor 56 meetpunten konden wel dergelijke tijdreeksen opgebouwd worden.

In het Menyanthesprogramma werden voor elk van de 56 meetpunten 20 tijdreeksen gesimuleerd. 
...
Het databestand waarmee de indicatoren berekend zullen worden bestaat uit : 56 meetpunten \* 34 jaar \* 365 metingen/jaar * 20 simulaties = 13.899.200 metingen.
...
**het _gemiddelde_ van de 1%-percentiel, 5%-percentiel, 10%-percentiel en 30%-percentiel van de grondwatermetingen _van een jaar_ in die peilbuis binnen de periode 1985 - 2015**

Het is dus niet de absolute percentielwaarde op alle metingen van die 30 jaar. 
...
Het zou wel kunnen om ze periodiek (10-15 jaar) te herberekenen.
